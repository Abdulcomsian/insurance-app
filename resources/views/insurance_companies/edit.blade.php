            ...
            <div id="msform">
                            ...
                            <fieldset style="{{$detailstyle}}">
                               <form action="{{route('company-details.update')}}" method="post">
                                @csrf
                                <input type="hidden" name="companyid" value="{{isset($company_details->id) ? $company_details->id: '' }}">
                               <div class="form-card">
                                        ...
                                        <div class="mb-5" style="position: relative;">
                                            ...
                                            <select name="country" required="required" style="position: absolute;" onmousedown="if(this.options.length>8){this.size=8;}"  onchange='this.size=0;' onblur="this.size=0;" data-control="select2" data-placeholder="Select a role" data-hide-search="true" class="form-select form-select-solid fw-bolder">
                                                ...
                                                @foreach($countries as $item)
                                                    @php
                                                     $selected='';
                                                    if($company_details->country==$item->country_name)
                                                    {
                                                        $selected="selected";
                                                    }
                                                    
                                                    @endphp
                                                    <option value="{{$item->country_name ?: null}}"   {{$selected}}>{{$item->country_name ?: 'Not Set'}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-5">
                                                @php
                                                 $active=''; 
                                                 $inactive='';
                                                 if(isset($company_details) && $company_details->status=="Active"){
                                                 $active="selected";
                                                 }else
                                                 {
                                                    $inactive="selected";
                            ...
                            <fieldset style="@if(isset($dirstyle)){{$dirstyle}}@else{{'display:none;'}}@endif">
                                 ...
                                 @php 
                                 if(session()->get('b_o_director'))
                                 {
                                   $b_o_direct=json_decode(session()->get('b_o_director'));
                                 }
                                 @endphp
                                 <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @if(session()->get('b_o_director'))
                                        @foreach($b_o_direct as $direct)
                                        <tr id="data-{{$direct->id}}">
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$direct->name}}</td>
                                            <td>{{$direct->designation}}</td>
                                            <td><span class="fas fa-trash deletedirctor" data-id="{{$direct->id}}"></span></td>
                                        </tr>
                                        @endforeach
                                        @endif
                                    </tbody>
                                        ...
                                        <div class="separator separator-dashed my-10"></div>
                                         ...
                                         <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" class="form-control form-control-solid" name="name[]" placeholder="Name"  value=""/>
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input type="text" name="designation[]" class="form-control form-control-solid" placeholder="Designation"  value=""/>
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            <!--end::Col-->
                            ...
                            <fieldset style="@if(isset($aacstyle)){{$aacstyle}}@endif">
                                 @php 
                                 if(session()->get('company_accounting'))
                                 {

                                  $company_accounting=session()->get('company_accounting');
                                 }
                                 @endphp
                                <form action="{{route('company-details.update')}}" method="post">
                                    @csrf
                                <div class="form-card">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="financial_strength_rating" placeholder="e.g A-" required="required" value="{{isset($company_accounting->financial_strength_rating) ? $company_accounting->financial_strength_rating : '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="gross_written_premium" placeholder="e.g YR 1,234,56" required="required" value="{{isset($company_accounting->gross_written_premium) ? $company_accounting->gross_written_premium : '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="gross_written_premium_year" placeholder="e.g 2010" required="required" value="{{isset($company_accounting->gross_written_premium_year) ? $company_accounting->gross_written_premium_year: '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="issue_credit_rating" placeholder="e.g bbb-" required="required" value="{{isset($company_accounting->issue_credit_rating) ? $company_accounting->issue_credit_rating: '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="s_andprating" placeholder="e.g AA-" required="required" value="{{isset($company_accounting->s_andprating) ? $company_accounting->s_andprating: '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="other_rating" placeholder="e.g BBB-' (Good) (FITCH RATINGS)" required="required" value="{{isset($company_accounting->other_rating) ? $company_accounting->other_rating: '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="public_listed_company" placeholder="e.g Palestine Securities Exchange (PSE)" required="required" value="{{isset($company_accounting->public_listed_company) ? $company_accounting->public_listed_company: '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" class="form-control form-control-solid" name="regulatory_authority" placeholder="e.g UAE Insurance Authority" required="required" value="{{isset($company_accounting->regulatory_authority) ? $company_accounting->regulatory_authority: '' }}"/>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                </div>
                               ...
                               <fieldset style="@if(isset($stastyle)){{$stastyle}}@endif">
                                   @php 
                                     if(session()->get('inc_st'))
                                     {

                                      $inc_st=session()->get('inc_st');
                                     }
                                  @endphp
                                   <form action="{{route('company-details.update')}}" method="post">
                                    @csrf
                                   <div class="form-card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" name="name" class="form-control form-control-solid" placeholder="Name" required="required" value="{{isset($inc_st->name) ? $inc_st->name : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Value</label>
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="value" class="form-control form-control-solid" placeholder="Value" required="required" value="{{isset($inc_st->value) ? $inc_st->value : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" name="year" class="form-control form-control-solid" placeholder="Year" required="required" value="{{isset($inc_st->year) ? $inc_st->year : '' }}"/>
                                        </div>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Name</label>
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" name="name" class="form-control form-control-solid" placeholder="Name" required="required" value="{{isset($invest->name) ? $invest->name : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Value</label>
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="value" class="form-control form-control-solid" placeholder="Value" required="required" value="{{isset($invest->value) ? $invest->value : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Year</label>
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" name="year" class="form-control form-control-solid" placeholder="Year" required="required" value="{{isset($invest->year) ? $invest->value : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Dsignation
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" name="designation" class="form-control form-control-solid" placeholder="Designation" required="required" value="{{isset($subsid->designation) ? $subsid->designation : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset style="@if(isset($shastyle)){{$shastyle}}@endif">
                                 @php 
                                     if(session()->get('mr_share'))
                                     {

                                      $mr_share=session()->get('mr_share');
                                     }
                                  @endphp
                                <form action="{{route('company-details.update')}}" method="post">
                                    @csrf
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="authorized_shares" class="form-control form-control-solid" placeholder="Authorized Share" required="required" value="{{isset($mr_share->authorized_shares) ? $mr_share->authorized_shares : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="issued_shares" class="form-control form-control-solid" placeholder="Issued Share" required="required" value="{{isset($mr_share->issued_shares) ? $mr_share->issued_shares : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="no_of_shares" class="form-control form-control-solid" placeholder="No of Share" required="required" value="{{isset($mr_share->no_of_shares) ? $mr_share->no_of_shares : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="paid_up_shares" class="form-control form-control-solid" placeholder="Paid up Share" required="required" value="{{isset($mr_share->paid_up_shares) ? $mr_share->paid_up_shares : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="total_share" class="form-control form-control-solid" placeholder="Total Share" required="required" value="{{isset($mr_share->total_share) ? $mr_share->total_share : '' }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset style="@if(isset($holstyle)){{$holstyle}}@endif">
                                @php 
                                     if(session()->get('shr_holder'))
                                     {

                                      $shr_holder=session()->get('shr_holder');
                                     }
                                  @endphp
                                <form action="{{route('company-details.update')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="separator separator-dashed my-10"></div>
                                     ...
                                     <div class="row gx-10 mb-5">
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text" name="name" class="form-control form-control-solid" placeholder="Name" required="required" value="{{isset($shr_holder->name) ? $shr_holder->name : '' }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="number" name="percentage" class="form-control form-control-solid" placeholder="Share Percentage" required="required" value="{{isset($shr_holder->percentage) ? $shr_holder->percentage : '' }}"/>
                                            </div>
                                        </div>
                                        <!--begin::Col-->
...
return false;
    ...
    <script type="text/javascript">
        $(".deletedirctor").click(function(){
            var director_id=$(this).attr("data-id");
             swal({
                title: "Are you sure?",
            ...
            function(){
                ...
                $.ajax({
                url:"{{route('director-delete')}}",
                method:"get",
                data:{id:director_id},
                success:function(res){
                     swal("Deleted!", "Director has been deleted!", "success");
                    $("#data-"+director_id+"").remove();
                },
                error:function(err)
                {
                     swal("Ooops!", "Somethin Wrong!", "error");
                }
