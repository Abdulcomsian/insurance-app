                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <input required type="text" name="company_name" class="form-control @error('company_name') is-invalid @else form-control-solid  @enderror" value="{{ old('company_name') }}"  placeholder="Company Name" />
                                                    @error('company_name')
